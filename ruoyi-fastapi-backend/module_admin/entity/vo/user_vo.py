...
class UserModel(BaseModel):
    ...
    user_source: Optional[int] = Field(default=None, description='用户来源（0默认，1飞书，2钉钉，3企业微信登录）')
    user_openid: Optional[str] = Field(default=None, description='用户openid')
    user_tenant_id: Optional[str] = Field(default=None, description='用户租户id')
