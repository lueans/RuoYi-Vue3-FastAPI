...
class UserModel(BaseModel):
    ...
    user_source: int | None = Field(default=None, description='用户来源（0默认，1飞书，2钉钉，3企业微信登录）')
    user_openid: str | None = Field(default=None, description='用户openid')
    user_tenant_id: str | None = Field(default=None, description='用户租户id')
