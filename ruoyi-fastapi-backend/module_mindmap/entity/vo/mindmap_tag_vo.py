...
class MindmapTagModel(BaseModel):
    ...
    tag_key: str = Field(min_length=1, max_length=100, pattern=r'^[a-zA-Z0-9_\-]+$', description='标签key(自定义必填)')
    name: str = Field(min_length=1, max_length=200, description='标签显示名称')
    ...
    description: str | None = Field(default=None, max_length=500, description='标签描述')
    created_by: str | None = Field(default=None, description='创建人')
    created_time: datetime | None = Field(default=None, description='创建时间')
